...
export default function Home() {
  ...
  if (!user) {
    return (
      <Layout>
        <section className="h-full px-4 py-[5vh]">
  ...
  return (
    <Layout>
      <section className="flex h-full gap-6 overflow-hidden border-b border-neutral-200 px-4 py-[5vh] dark:border-neutral-800 md:gap-10">
