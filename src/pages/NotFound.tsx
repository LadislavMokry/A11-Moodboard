    ...
    <Layout>
      <section className="flex min-h-[calc(100vh-4rem)] flex-col justify-center space-y-3">
        ...
        <p className="text-neutral-600 dark:text-neutral-300">
          The page you were looking for could not be located. It may have been moved or removed.
        </p>
        <Link
          to="/"
          className="inline-flex w-fit items-center rounded-md bg-violet-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-violet-700"
        >
          Return home
        </Link>
      </section>
