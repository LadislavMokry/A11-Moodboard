          ...
          <div className="flex items-start justify-between gap-4 mb-6">
            <div>
              ...
              <Dialog.Description className="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
                Enter an image URL to import it to your board
              </Dialog.Description>
            </div>
            <Dialog.Close asChild>
              <button
                ...
                className="rounded-full p-1 text-neutral-500 transition-colors hover:bg-neutral-100 hover:text-neutral-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-violet-500 dark:text-neutral-400 dark:hover:bg-neutral-800 dark:hover:text-neutral-100 disabled:opacity-50"
                aria-label="Close"
              >
                <X className="h-4 w-4" />
              </button>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <input
                ...
                disabled={isImporting}
                {...register('url')}
                className="w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 shadow-sm focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/20 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-100 disabled:opacity-50"
            ...
            <div className="flex items-center justify-between pt-4">
              <p className="text-xs text-neutral-500 dark:text-neutral-400">
                Supported: JPG, PNG, WebP, GIF (max 10 MB)
              </p>
