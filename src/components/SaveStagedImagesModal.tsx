...
export function SaveStagedImagesModal({
  open,
  onOpenChange,
  files,
  onSuccess,
}: SaveStagedImagesModalProps) {
  ...
  const filteredBoards =
    boards?.filter((board) => board.name.toLowerCase().includes(searchQuery.toLowerCase())) ?? [];
        ...
        <Dialog.Content className="fixed left-[50%] top-[50%] z-50 w-full max-w-lg translate-x-[-50%] translate-y-[-50%] rounded-lg border border-neutral-200 bg-white p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] dark:border-neutral-800 dark:bg-neutral-900">
              ...
              <>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-neutral-200 bg-white py-2 pl-10 pr-4 text-sm text-neutral-900 placeholder-neutral-500 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/20 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 dark:placeholder-neutral-400"
                  />
                </div>
                      ...
                      <button
                        ...
                        className={`w-full rounded-md p-3 text-left transition-colors ${
                          selectedBoardId === board.id
                            ...
                            : 'bg-white text-neutral-900 hover:bg-neutral-100 dark:bg-neutral-900 dark:text-neutral-50 dark:hover:bg-neutral-800'
                        }`}
                      >
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength={60}
                    className="mt-1.5 w-full rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm text-neutral-900 placeholder-neutral-500 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500/20 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 dark:placeholder-neutral-400"
                    autoFocus
                  />
                  <p className="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
                    {newBoardName.length}/60 characters
                  </p>
                </div>
              </>
            )}
          ...
          <div className="mt-6 flex justify-end gap-3">
            ...
            <button
              ...
              disabled={
                isUploading ||
                (mode === 'select' ? !selectedBoardId : !newBoardName.trim())
              }
              className="flex items-center gap-2 rounded-md bg-violet-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-violet-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
