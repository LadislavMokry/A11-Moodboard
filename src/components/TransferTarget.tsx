    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          >
            <div className={`flex h-10 w-10 items-center justify-center rounded-lg transition-colors ${isOver ? "bg-pink-500 text-white" : "bg-pink-100 text-pink-400 dark:bg-pink-950/40 dark:text-pink-400"}`}>
              <ArrowRight className="h-5 w-5" />
            </div>
            <div>
              <p className={`text-sm font-medium transition-colors ${isOver ? "text-pink-600 dark:text-pink-400" : "text-neutral-700 dark:text-neutral-300"}`}>Transfer to...</p>
